...
import {
  SimSetupConfigureForm
} from './widgets/sim-setup-configure-form';

import {
  SimSetupCreateForm
} from './widgets/sim-setup-create-form';

import {
  SimSelectForm
} from './widgets/sim-select-form';
...
export function addCommands(
    ...
    execute: async () => {
      ...
      if ( result.button.accept ) {
        ...
        try {
          ...
          console.log(
            `[${CommandIDs.createSimSetup}] ${create.status}`
          );
        } catch ( error ) {
          console.error( error );
          showErrorMessage(
            'An error occurred while attempting to create a new simulation setup!', error
          );
        }
      }
    }
  ...
  app.commands.addCommand( CommandIDs.configureSimSetup, {
    ...
    caption: 'Update the configuration of an existing mosaik-docker simulation setup.',
    isEnabled: () => model.isValidSimSetup,
    ...
    execute: async () => {
      ...
      const result = await showDialog( {
        ...
        body: new SimSetupConfigureForm(),
        focusNodeSelector: 'input',
        buttons: [
          Dialog.cancelButton(),
      ...
      if ( result.button.accept ) {
        ...
        try {
          ...
          console.log(
            `[${CommandIDs.configureSimSetup}] ${config.status}`
          );
        } catch ( error ) {
          console.error( error );
          showErrorMessage(
            'An error occurred while attempting to configure the simulation setup!', error
          );
        }
      }
    }
  ...
  app.commands.addCommand( CommandIDs.checkSimSetup, {
    ...
    execute: async () => {
      try {
        ...
        console.log(
          `[${CommandIDs.checkSimSetup}] ${check.status}`
        );
        ...
        if ( true === check.valid ) {
          ...
          showErrorMessage(
            'Simulation setup is invalid', check.status
          );
        }
        ...
        console.error( error );
        showErrorMessage(
          'An error occurred while attempting to check the simulation setup!', error
        );
      }
    }
  } );
  ...
  app.commands.addCommand( CommandIDs.buildSimSetup, {
    ...
    execute: async () => {
      try {
        ...
        console.error( error );
        showErrorMessage(
          'An error occurred while attempting to build the simulation setup!', error
        );
      }
    }
  } );
  ...
  app.commands.addCommand( CommandIDs.startSim, {
    ...
    execute: async () => {
      try {
        ...
        console.log(
          `[${CommandIDs.startSim}] ${start.status}`
        );
        ...
        console.error( error );
        showErrorMessage(
          'An error occurred while attempting to start a simulation!', error
        );
      }
    }
  } );
  ...
  app.commands.addCommand( CommandIDs.cancelSim, {
    ...
    execute: async () => {
      try {
        ...
        if ( result.button.accept ) {
          const cancelId = result.value.selectAll ? 'all' : result.value.selectItem;
          const cancel = await model.cancelSim( cancelId );
          console.log(
            `[${CommandIDs.cancelSim}] ${cancel.status}`
            );
        }
        ...
        console.error( error );
        showErrorMessage(
          'An error occurred while attempting to cancel a simulation!', error
        );
      }
    }
  } );
  ...
  app.commands.addCommand( CommandIDs.clearSim, {
    ...
    execute: async () => {
      try {
        ...
        if ( result.button.accept ) {
          const clearId = result.value.selectAll ? 'all' : result.value.selectItem;
          const clear = await model.clearSim( clearId );
          console.log(
            `[${CommandIDs.clearSim}] ${clear.status}`
            );
        }
        ...
        console.error( error );
        showErrorMessage(
          'An error occurred while attempting to clear a simulation!', error
        );
      }
    }
  } );
  ...
  app.commands.addCommand( CommandIDs.getSimResults, {
    ...
    execute: async () => {
      try {
        ...
        if ( result.button.accept ) {
          const getResultsId = result.value.selectAll ? 'all' : result.value.selectItem;
          const getResults = await model.getSimResults( getResultsId );
          console.log(
            `[${CommandIDs.getSimResults}] ${getResults.status}`
            );
        }
        ...
        console.error( error );
        showErrorMessage(
          'An error occurred while attempting to get the simulation results!', error
        );
      }
    }
  } );
  ...
  app.commands.addCommand( CommandIDs.getSimStatus, {
    ...
    execute: async args => {
      ...
      try {
        ...
        if ( !suppressError ) {
          showErrorMessage(
            'An error occurred while attempting to display the simulation status!', error
          );
        }
      }
    }
  ...
  app.commands.addCommand( CommandIDs.deleteSimSetup, {
    ...
    caption: 'Delete a simulation setup, including all associated Docker images and containers.',
    isEnabled: () => model.isValidSimSetup,
    ...
    execute: async () => {
      ...
      if ( result.button.accept ) {
        try {          
          ...
          console.log(
            `[${CommandIDs.deleteSimSetup}] ${del.status}`
          );
        } catch ( error ) {
          console.error( error );
          showErrorMessage(
            'An error occurred while attempting to delete the simulation setup!', error
          );
        }
      }
    }
